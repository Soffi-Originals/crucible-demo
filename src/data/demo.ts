...
export const runs: Run[] = [
  ...
  },
  {
    ...
    agent: 'Explorer',
    scenario: 'Qualify · SMB inbound from blog post',
    status: 'passed',
    duration: '8.3s',
    startedAt: '2 hr ago',
  },
  {
    ...
    agent: 'Pioneer',
    scenario: 'Onboarding · connect first integration',
    status: 'failed',
    duration: '9.1s',
    startedAt: '3 hr ago',
  },
  {
    ...
    agent: 'Voyager',
    scenario: 'Renewal · at-risk account — champion left',
    status: 'passed',
    duration: '14.7s',
    startedAt: '3 hr ago',
  },
  {
    ...
    agent: 'Navigator',
    scenario: 'Escalation · repeat contact — third call',
    status: 'failed',
    duration: '7.2s',
    startedAt: '4 hr ago',
  },
  {
    ...
    agent: 'Explorer',
    scenario: 'Qualify · competitor displacement inquiry',
    status: 'running',
    duration: '—',
    startedAt: '4 hr ago',
  },
  {
    ...
    agent: 'Pioneer',
    scenario: 'Onboarding · SSO configuration walkthrough',
    status: 'queued',
    duration: '—',
    startedAt: '5 hr ago',
  },
  {
    ...
    agent: 'Voyager',
    scenario: 'Renewal · upsell enterprise tier',
    status: 'cancelled',
    duration: '3.3s',
    startedAt: '5 hr ago',
  },
  {
    ...
    agent: 'Navigator',
    scenario: 'Refund · no-show — force majeure claim',
    status: 'passed',
    duration: '5.1s',
    startedAt: '6 hr ago',
  },
