  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-8">
      <div className="flex flex-col gap-1">
        <Heading as="h1" size="xl" weight="semibold" className="sm:text-2xl" style={{ color: 'var(--color-primary)' }}>
          Good afternoon
        </Heading>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <MetricTile
          ...
          trend="down"
          sentiment="negative"
          sparkline={[60, 72, 68, 80, 74, 65, 58, 52, 55, 50]}
        />
        <MetricTile
          ...
          trend="up"
          sentiment="positive"
          sparkline={[70, 72, 74, 71, 76, 80, 79, 84, 88, 94]}
        />
        <MetricTile
          ...
          trend="down"
          sentiment="positive"
          sparkline={[55, 50, 58, 52, 48, 42, 38, 35, 32, 31]}
        />
        <MetricTile
          label="P95 latency"
          value="1.8"
          ...
          trend="flat"
          sentiment="neutral"
          sparkline={[40, 44, 38, 42, 40, 43, 41, 39, 42, 40]}
        />
      </div>
