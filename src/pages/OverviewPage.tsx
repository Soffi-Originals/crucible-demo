    ...
    <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <MetricTile
          ...
          trend="up"
          sentiment="positive"
          sparkline={[91.2, 91.8, 92.0, 92.5, 93.1, 93.6, 94.2]}
        />
        <MetricTile
          ...
          trend="down"
          sentiment="negative"
          sparkline={[13200, 13050, 12980, 13100, 12870, 12600, 12481]}
        />
        <MetricTile
          label="P95 latency"
          value="1.8"
          ...
          trend="flat"
          sentiment="neutral"
          sparkline={[1.9, 1.75, 1.85, 1.8, 1.78, 1.82, 1.8]}
        />
        <MetricTile
          ...
          trend="down"
          sentiment="positive"
          sparkline={[3.8, 3.7, 3.5, 3.4, 3.3, 3.2, 3.1]}
        />
      </div>
